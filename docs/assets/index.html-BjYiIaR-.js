import{_ as a,c as n,a as t,o as r}from"./app-xRlI9cPS.js";const s={};function p(c,e){return r(),n("div",null,[...e[0]||(e[0]=[t(`<h1 id="_1-使用react脚手架创建一个react应用" tabindex="-1"><a class="header-anchor" href="#_1-使用react脚手架创建一个react应用"><span>1. 使用React脚手架创建一个React应用</span></a></h1><h2 id="_1-react脚手架" tabindex="-1"><a class="header-anchor" href="#_1-react脚手架"><span>1). react脚手架</span></a></h2><pre><code>1. xxx脚手架: 用来帮助程序员快速创建一个基于xxx库的模板项目
	* 包含了所有需要的配置
	* 指定好了所有的依赖
	* 可以直接安装/编译/运行一个简单效果
...
</code></pre>`,36)])])}const o=a(s,[["render",p]]),h=JSON.parse('{"path":"/article/v3e00uw9/","title":"React案例","lang":"zh-CN","frontmatter":{"title":"React案例","date":"2022-08-04T00:00:00.000Z","tags":["React","案例"],"categories":["自学篇"],"createTime":"2025/08/24 00:25:17","permalink":"/article/v3e00uw9/"},"readingTime":{"minutes":3.42,"words":1025},"git":{"createdTime":1762223206000,"updatedTime":1762223792000,"contributors":[{"name":"袁果锅","username":"","email":"2914310412@qq.com","commits":2,"avatar":"https://gravatar.com/avatar/ebb36e92893d0bad96657e83c4e1e8be47c5ebe9e1f87275acd48573e4759004?d=retro"}]},"filePathRelative":"React笔记/02_react案例_笔记.md","headers":[],"categoryList":[{"id":"5782db","sort":10010,"name":"React笔记"}]}');export{o as comp,h as data};
